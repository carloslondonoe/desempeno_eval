...
use Session;
use CRUDBooster;
class ReportesGeneralCiclos extends Controller
{
  ...
  return view('reportes_generales/ciclos',
          compact('puntuacionfnl', 'liderazgo','innovacion','trabajoenequipo','ciclo','ano','acargo')
        );
