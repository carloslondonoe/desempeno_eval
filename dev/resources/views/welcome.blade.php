  ...
  <head>
    ...
    <style type="text/css">
      .login-page, .register-page {
          ...
          background-color: #6c2b2b !important;
      }
  ...
  <body class="login-page">
    ...
    <div class="login-box">
      <div class="login-logo">
        <a href="{{url('/')}}">
            <img title='{!!(CRUDBooster::getSetting('appname') == 'CRUDBooster')?"<b>CRUD</b>Booster":CRUDBooster::getSetting('appname')!!}' src='{{ CRUDBooster::getSetting("logo")?asset(CRUDBooster::getSetting('logo')):asset('https://academia.motoborda.com/pluginfile.php/1/theme_mb2cg/logo/1585625680/Rojo%20sin%20fondo.png') }}' style='max-width: 100%;max-height:170px'/>
        </a>
      </div><!-- /.login-logo -->      
      <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
          ...
          <div class="form-group has-feedback">
            <input autocomplete='off'  type="text" class="form-control" name='documento' required placeholder="Documento"/>
